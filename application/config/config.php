...
//$config['base_url']	= "http://localhost/mnc.co.id/";
...
define('HTTP_IMAGE_UPLOADED_PATH', $config['base_url'].'uploads/');
define('HTTP_IMAGE_UPLOADED_PATH_DEFAULT', $config['base_url'].'comic/');
define('HTTP_IMAGE_UPLOADED_PATH_DEFAULT_SMALL', $config['base_url'].'comic/small/');
define('HTTP_IMAGE_UPLOADED_PATH_DEFAULT_THUMB', $config['base_url'].'comic/thumb/');
define('HTTP_IMAGE_UPLOADED_PATH_DEFAULT_TN', $config['base_url'].'comic/tn/');
