...
class Publication extends CI_Controller {
    ...
    public function all(){
        ...
        $category = $this->getCategoryIdByName('Publikasi');
        ...
        //get the posts data
        $arr['publication'] = $this->postpromo->getRows(array('limit'=>$this->perPage, 'category' => $category));
    ...
    function ajaxPaginationData(){
        ...
        //get the posts data
        $arr['publication'] = $this->postpromo->getRows(array('start'=>$page,'limit'=>$this->perPage, 'category' => $category));

        //load the view
        $this->load->view('vwPublicationPagination', $arr, false);
    }
