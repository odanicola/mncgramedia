...
class Book extends CI_Controller {
    ...
    public function all() {
        ...
        $totalRec = count($this->novel->getRows(array('country' => $country, 'genre' => $genre, 'category' => $category)));

        $config = array();
        //pagination configuration

        $config['div']         = 'comicList'; //parent div tag id
        $config["base_url"]    = base_url().'book/ajaxPaginationData';
        ...
        $arr['novel'] = $this->novel->getRows(array('limit'=>$this->perPage, 'country' => $country, 'genre' => $genre, 'category' => $category));
    ...
    function ajaxPaginationData(){
        ...
        //get the posts data
        $arr['novel'] = $this->novel->getRows(array('start'=>$page,'limit'=>$this->perPage, 'country' => $country, 'genre' => $genre, 'category' => $category));
