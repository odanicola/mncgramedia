...
*/
    ...
    public function import_comic(){
      ...
      if (!$this->upload->do_upload()) {
          ...
          $file_data = $this->upload->data();
          //$file_path = './uploads/csv/coba.csv';
          $file_path =  './uploads/csv/'.$file_data['file_name'];
          //var_dump($file_data);
          //echo '<br/>';
          //var_dump($file_path);
          ...
          if ($this->csvimport->get_array($file_path)) {
              ...
              foreach ($csv_array as $row) {
                  ...
                  if(!(strpos($row['published_date'],'/'))){
                     $publish_date       = explode('-', $row['published_date']);

                     $tgl_publish_date       = $publish_date[0];
                     $bulan_publish_date     = $publish_date[1];
                  ...
                  //die();
                  //var_dump($this->csv_model->check_id($row['id']));
                  //die();
                  //echo $this->csv_model->check_id($row['id']);
