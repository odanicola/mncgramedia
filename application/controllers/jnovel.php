...
class Jnovel extends CI_Controller {
    ...
    public function all() {
        ...
        $totalRec = count($this->novel->getRowsJnovel(array('category'=>$category_id)));
        $config = array();
        //pagination configuration

        $config['div']         = 'comicList'; //parent div tag id
        $config["base_url"]    = base_url().'jnovel/ajaxPaginationData';
        ...
        $arr['novel'] = $this->novel->getRowsJnovel(array('limit'=>$this->perPage,'category'=>$category_id));
