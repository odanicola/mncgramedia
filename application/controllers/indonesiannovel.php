...
class IndonesianNovel extends CI_Controller {
    ...
    public function all() {
        ...
        $totalRec = count($this->novel->getRowsInovel(array('category'=>$category_id)));
        $config = array();
        //pagination configuration

        $config['div']         = 'comicList'; //parent div tag id
        $config["base_url"]    = base_url().'indonesiannovel/ajaxPaginationData';
        ...
        $arr['novel'] = $this->novel->getRowsKnovel(array('limit'=>$this->perPage,'category'=>$category_id));
    ...
    function ajaxPaginationData(){
        ...
        //get the posts data
        $arr['novel'] = $this->novel->getRowsJnovel(array('start'=>$offset,'limit'=>$this->perPage,'category'=>$category_id));
