...
class Knovel extends CI_Controller {
    ...
    public function all() {
        ...
        $totalRec = count($this->novel->getRowsKnovel(array('category'=>$category_id)));
        $config = array();
        //pagination configuration

        $config['div']         = 'comicList'; //parent div tag id
        $config["base_url"]    = base_url().'knovel/ajaxPaginationData';
