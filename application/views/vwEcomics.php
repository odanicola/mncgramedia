        ...
        <ul class="liststyle-none our-clients2 coming-soon padding-nol margin-nol ">
          <?php
            ...
            foreach ($coming_soon as $key => $value) {
                ...
                $catalog_harga = "Rp ".number_format($value['price'],2,',','.');
          ?>
...
$(document).on('change','#category',function(){
   ...
   if(cat == 'all'){
	   ...
	   var url = window.location = "<?php echo base_url()?>ecomics";
   } else {
	   var url = window.location = "<?php echo base_url()?>ecomics/?category="+cat;
   }
...
$(document).on('change','#genre',function(){
   ...
   if(cat == 'all'){
	   ...
	   var url = window.location = "<?php echo base_url()?>ecomics/?genre="+cat;
   }
...
$(document).on('change','#country',function(){
   ...
   if(country == 'all'){
	   ...
	   var url = window.location = "<?php echo base_url()?>ecomics/?country="+country;
   }
   $.ajax({
        type: "POST",
        url: url,
