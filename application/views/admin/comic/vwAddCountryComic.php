...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1>Country Comic <small>Add New Page </small></h1>
            <ol class="breadcrumb">
    ...
    <div class="col-lg-10">
        <form method="post" action="<?php echo base_url(); ?>admin/country_comic/add_country_comic" role="form">
        <div class="form-group">
            <label for="origin">Origin</label>
            <input type="text" name="origin" class="form-control input-sm" placeholder="Comic Origin">
        </div>
        <div class="form-group">
