...
-->
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>CMS <small>COMIC Editor's Choice Module </small><small><a href="<?php echo base_url();?>admin/comic/add_new"
            ...
            <div class="table-responsive">
              <form id="frm-example" action="<?php echo base_url(); ?>admin/comic/delete_comic_all_editorchoice/" method="POST">
              <select name="action">
              ...
              <table class="table table-hover tablesorter" id="myTable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="<?php echo base_url(); ?>admin/comic/edit_comic_editorchoice/<?php echo $val['id']; ?>" class="btn btn-primary btn-xs">Edit</a>
              							...
              							<div class="modal-dialog">
              								<div class="modal-content">
              									...
              									<div class="modal-footer">
              										<a href="<?php echo base_url(); ?>admin/comic/delete_comic_editorchoice/<?php echo $val['id']; ?>" class="btn btn-danger btn-xs">Yes</a>
