...
-->
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>CMS <small>Novel Best Seller Module </small><small><a href="<?php echo base_url();?>admin/novel/add_new"
            ...
            <div class="table-responsive">
              <form id="frm-example" action="<?php echo base_url(); ?>admin/novel/delete_novel_all_bestseller/" method="POST">
              <select name="action">
              ...
              <table class="table table-hover tablesorter" id="myTable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="<?php echo base_url(); ?>admin/novel/edit_novel_bestseller/<?php echo $val['id']; ?>" class="btn btn-primary btn-xs">Edit</a>
              							...
              							<div class="modal-dialog">
              								<div class="modal-content">
              									...
              									<div class="modal-footer">
              										<a href="<?php echo base_url(); ?>admin/novel/delete_novel_bestseller/<?php echo $val['id']; ?>" class="btn btn-danger btn-xs">Yes</a>
