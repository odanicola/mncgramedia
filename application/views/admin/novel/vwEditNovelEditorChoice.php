...
<div id="page-wrapper">
  ...
  <?php } else { echo '<div></div>';}?>
    ...
    <div class="col-lg-9">
        <form method="post" action="<?php echo base_url(); ?>admin/novel/update_novel_editorchoice" role="form" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <?php
                $image_value = '';
                if(isset($novel_image[0]['image_large']) && !empty($novel_image[0]['image_large'])) {?>
                <img src="<?php echo HTTP_IMAGE_UPLOADED_PATH . $novel_image[0]['image_large'];?>" class="thumbnail" height="350" style="margin-bottom: 20px">
                <?php $image_value = $novel_image[0]['image_large'];?>
            <?php } elseif (isset($novel[0]['image_large']) && !empty($novel[0]['image_large'])){?>
                <img src="<?php echo HTTP_IMAGE_UPLOADED_PATH . $novel[0]['image_large'];?>" height="350" class="thumbnail" style="margin-bottom: 20px">
                <?php $image_value = $novel[0]['image_large'];?>
            <?php }
            else{ echo "No Cover Image"; } ?>
