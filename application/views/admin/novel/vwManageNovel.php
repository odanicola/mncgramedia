...
-->
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>CMS <small>Novel Module </small><small><a href="<?php echo base_url();?>admin/novel/add_new"
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $val['author']; ?></td>
          					<td>
          						<?php
          							foreach($novel_category as $cat => $value){
                    ...
                    <td>
                        <a href="<?php echo base_url(); ?>admin/novel/edit_novel/<?php echo $val['id']; ?>" class="btn btn-primary btn-xs">Edit</a>
            							...
            							<div class="modal-dialog">
            								<div class="modal-content">
            									...
            									<div class="modal-footer">
            										<a href="<?php echo base_url(); ?>admin/novel/delete_novel/<?php echo $val['id']; ?>" class="btn btn-danger btn-xs">Yes</a>
