...
-->
      ...
      <div id="page-wrapper">
        ...
        <?php
        if(!is_null($this->session->flashdata('novel'))){ $message = $this->session->flashdata('novel');?>
            <div class="<?php echo $message['class']?>" role="alert" style="margin-top: 20px;"><?php echo $message['message'];?></div>
        <?php } else { echo '<div></div>';}?>

        <div class="row">
          <div class="col-lg-12">
            <h1>CMS <small>Novel Editor's Choice Module </small><small><a href="<?php echo base_url();?>admin/novel/add_new"
            class="add-new" >Add New</a></small></h1>
            <ol class="breadcrumb">
              <li><a href="#"><i class="icon-dashboard"></i> Novel</a></li>
            ...
            <div class="table-responsive">
              <form id="frm-example" action="<?php echo base_url(); ?>admin/novel/delete_novel_all_editorchoice/" method="POST">
              <select name="action">
              ...
              <table class="table table-hover tablesorter" id="myTable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="<?php echo base_url(); ?>admin/novel/edit_novel_editorchoice/<?php echo $val['id']; ?>" class="btn btn-primary btn-xs">Edit</a>
              							...
              							<div class="modal-dialog">
              								<div class="modal-content">
              									<div class="modal-header">
              										...
              										<h3>Delete Novel - Confirmation Delete</h3>
              									</div>
              									<div class="modal-body">
              										<p>Are you sure to delete this novel with ID: <?php echo $val['id'];?> ?</p>
              									</div>
              									<div class="modal-footer">
              										<a href="<?php echo base_url(); ?>admin/novel/delete_novel_editorchoice/<?php echo $val['id']; ?>" class="btn btn-danger btn-xs">Yes</a>
