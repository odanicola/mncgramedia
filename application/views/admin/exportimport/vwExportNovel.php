...
<div id="page-wrapper">
  ...
  <?php
  if(!is_null($this->session->flashdata('exportnovel'))){ $message = $this->session->flashdata('exportnovel');?>
      <div class="<?php echo $message['class']?>" role="alert" style="margin-top: 20px;"><?php echo $message['message'];?></div>
  <?php } else { echo '<div></div>';}?>

    <div class="row">
        <div class="col-lg-12">
            <h1>Export <small>Novel</small></h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url(); ?>admin/export/novel/"><i class="icon-dashboard"></i> Export</a></li>
                <li class="active"><i class="icon-file-alt"></i> Export Novel Page</li>
            </ol>
        </div>
    </div><!-- /.row -->
    ...
    <div class="col-lg-10">
        <form method="post" action="<?php echo base_url(); ?>admin/exportimport/export_novel" role="form" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <option value="<?php echo $novel_category[$key]['id'];?>">
              <?php echo $novel_category[$key]['title'];?>
            </option>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1>Import <small>Novel</small></h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url(); ?>admin/exportimport/novel/"><i class="icon-dashboard"></i> Import</a></li>
                <li class="active"><i class="icon-file-alt"></i> Import Novel Page</li>
            </ol>
        </div>
    </div><!-- /.row -->
    ...
    <div class="fld col-lg-12">
      <div class="col-lg-10">
        <form method="post" action="<?php echo base_url(); ?>admin/exportimport/import_novel" role="form" enctype="multipart/form-data">
          <div class="form-group">
